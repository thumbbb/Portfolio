...
(function($) {
    ...
    $("#process .detail_btn").click(function(){
    $(this).next().addClass("license_show");
     });
    $("#process .license_box .close_btn").click(function(){
      $("#process .license_box").removeClass('license_show');
    });
